...
* `TRV_CACHE` = string            - The output directory for compilation, defaults to `.out` of the cwd
* `TRV_COMPILER` = string         - The output directory of the compiler.  This is a subset of 
