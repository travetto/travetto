...
<!-- Please modify https://github.com/travetto/travetto/tree/master/related/generator-app/DOCS.js and execute "npm run docs" to rebuild -->
...
The [Data Modeling Core](https://github.com/travetto/travetto/tree/master/module/model#readme "Datastore abstraction for core operations.") allows for modeling of application data, and provides mechanisms for storage and retrieval.  When setting up your application, you will need to select which database backend you want to use:
...
A default model is constructed, a [Todo](https://github.com/travetto/travetto/tree/master/related/generator-app/templates/todo/src/model/todo.ts#L4) class:
...
## Rest + Model
In the case both `rest` and `model` features are enabled, the code will produce a controller that exposes the [Todo](https://github.com/travetto/travetto/tree/master/related/generator-app/templates/todo/src/model/todo.ts#L4) model via restful patterns.
