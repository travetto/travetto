...
export const PAGES = [
    ...
    subs: [
      ...
      },
      {
        ...
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/schema-faker/schema-faker.component').then(item => item.SchemaFakerComponent)
      }
    ]
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        title: 'LLM Support',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/llm-support/llm-support.component').then(item => item.LlmSupportComponent)
      },
      {
        path: 'vscode-plugin',
        title: 'VS Code Plugin',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/vscode-plugin/vscode-plugin.component').then(item => item.VSCodePluginComponent)
      }
    ]
  },
  {
    ...
    subs: [
      {
        ...
        title: 'DynamoDB',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-dynamodb/model-dynamodb.component').then(item => item.ModelDynamodbComponent)
      },
      {
        path: 'model-file',
        title: 'File',
      ...
      {
        path: 'model-firestore',
        title: 'Firestore',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-firestore/model-firestore.component').then(item => item.ModelFirestoreComponent)
      },
      {
        path: 'model-indexed',
        title: 'Indexed',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-indexed/model-indexed.component').then(item => item.ModelIndexedComponent)
      },
      {
        path: 'model-memory',
        title: 'Memory',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-memory/model-memory.component').then(item => item.ModelMemoryComponent)
      },
      {
        path: 'model-redis',
        title: 'Redis',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-redis/model-redis.component').then(item => item.ModelRedisComponent)
      },
      {
        path: 'model-s3',
        title: 'S3',
  ...
  },
  {
    ...
    subs: [
      {
        path: 'model-elasticsearch',
        title: 'Elasticsearch',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-elasticsearch/model-elasticsearch.component').then(item => item.ModelElasticsearchComponent)
      },
      {
        path: 'model-mongo',
        title: 'Mongo',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-mongo/model-mongo.component').then(item => item.ModelMongoComponent)
      },
      {
        path: 'model-sql',
        title: 'SQL',
      ...
      },
      {
        ...
        title: 'Mysql',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-mysql/model-mysql.component').then(item => item.ModelMysqlComponent)
      },
      {
        path: 'model-postgres',
        title: 'Postgres',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-postgres/model-postgres.component').then(item => item.ModelPostgresComponent)
      },
      {
        path: 'model-sqlite',
        title: 'Sqlite',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-sqlite/model-sqlite.component').then(item => item.ModelSqliteComponent)
      },
      {
        path: 'model-query-language',
        title: 'Query Language',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/model-query-language/model-query-language.component').then(item => item.ModelQueryLanguageComponent)
      }
    ]
  },
  {
    ...
    subs: [
      {
        ...
        title: 'AWS Lambda',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/web-aws-lambda/web-aws-lambda.component').then(item => item.WebAwsLambdaComponent)
      },
      {
        path: 'web-upload',
        title: 'Upload',
  ...
  },
  {
    ...
    subs: [
      ...
      {
        path: 'auth-web-passport',
        title: 'Web Passport',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/auth-web-passport/auth-web-passport.component').then(item => item.AuthWebPassportComponent)
      },
      {
        path: 'auth-web-session',
        title: 'Web Session',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/auth-web-session/auth-web-session.component').then(item => item.AuthWebSessionComponent)
      },
      {
        path: 'auth-session',
        title: 'Session',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/auth-session/auth-session.component').then(item => item.AuthSessionComponent)
      },
      {
        path: 'auth-model',
        title: 'Model',
    ...
    subs: [
      {
        ...
        title: 'Compiler',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/email-compiler/email-compiler.component').then(item => item.EmailCompilerComponent)
      },
      {
        path: 'email-nodemailer',
        title: 'Nodemailer',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/email-nodemailer/email-nodemailer.component').then(item => item.EmailNodemailerComponent)
      },
      {
        path: 'email-inky',
        title: 'Inky',
  ...
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        title: 'Transformer',
        loadComponent: (): Promise<Type<unknown>> =>
          import('./gen/transformer/transformer.component').then(item => item.TransformerComponent)
      },
      {
        path: 'manifest',
        title: 'Manifest',
