...
2029-03-14T04:00:00.618Z info  [@travetto/config:src/service.ts:149] Initialized {
  ...
  config: {
    ...
    active: {
      ...
      WebHttpConfig: { httpVersion: '1.1', port: 12555, bindAddress: '0.0.0.0', ssl: false },
      WebLogConfig: { applies: true, showStackTrace: true },
      WebRpcConfig: { clients: [] }
    }
  }
}
2029-03-14T04:00:00.837Z info  [@travetto/web-http-server:src/http.ts:56] Listening { port: 12555 }
```
