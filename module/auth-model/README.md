...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/auth-model/README.ts and execute "npx trv doc" to rebuild -->
...
This module supports the integration between the [Authentication](module/auth#readme "Authentication scaffolding for the travetto framework") module and the [Data Modeling Support](module/model#readme "Datastore abstraction for core operations."). 
...
Currently, the following are packages that provide [CRUD](https://github.com/travetto/travetto/tree/main/module/model/src/service/crud.ts#L11):
   ...
   *  [Firestore Model Support](module/model-firestore#readme "Firestore backing for the travetto model module.") - @travetto/model-firestore
