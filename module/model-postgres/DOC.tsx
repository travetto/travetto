...
export const text = <>
  <c.StdHeader />
  This module provides a {d.library('Postgres')}-based implementation for the {d.mod('Model')} module.  This source allows the {d.mod('Model')} module to read, write and query against {d.library('SQL')} databases. In development mode, the {SQLModelService} will also modify the database schema in real time to minimize impact to development. <br />
