...
export const text = (
  <>
    ...
    {d.module('Model')} module to read, write and query against {d.library('SQL')} databases. In development mode, the {PostgresModelService}{' '}
    ...
    a {d.library('SQL')} database. Every table generated maps to a model, with simple fields mapped as individual columns and complex fields/arrays mapped as native {d.input('JSONB')} columns. <br />
    Supported features:
    <ul>
