...
This module provides a ${lib.Postgres}-based implementation for the ${mod.Model} module.  This source allows the ${mod.Model} module to read, write and query against ${lib.SQL} databases. In development mode, the ${SQLModelService} will also modify the database schema in real time to minimize impact to development.
