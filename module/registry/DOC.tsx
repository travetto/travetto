    ...
    <c.Section title="Flows">
      ...
      <c.SubSection title="Initial Flows">
        ...
        <ol>
          ...
          <li>
            When all files are processed, the {Registry} is finished, and it will signal to anything waiting on registered data that its
            free to use it.
          </li>
        </ol>
        ...
        The registry index is a {RegistryIndexContract} that similar to the {d.module('Schema')}'s Schema registry and {d.module('Di')}'s
        Dependency registry.
      </c.SubSection>
