...
export const text = <>
  ...
  <c.Section title='Sending Compiled Templates'>
    ...
    With {d.input('.html')} being the only required field.  The {d.module('EmailCompiler')} module supports this format, and will generate files accordingly. Also, note that {d.input('<key>')} can include slashes, allowing for nesting folders.
  </c.Section>
</>;
