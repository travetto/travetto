...
export const text = (
  <>
    <c.StdHeader />
    Given the integration with {d.library('NodeMailer')}, all extensions should be usable out of the box. The primary{' '}
    {d.library('NodeMailer')} modules are provided (assuming dependencies are installed):
