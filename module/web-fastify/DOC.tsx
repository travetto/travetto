...
export const text = <>
  <c.StdHeader />
  The module is an {d.library('Fastify')} provider for the {d.mod('Web')} module.  This module provides an implementation of {WebApplication} for automatic injection in the default Web server.
