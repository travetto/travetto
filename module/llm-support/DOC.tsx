...
export const text = (
  <>
    ...
    The {d.module('LlmSupport')} module provides guided LLM assistance for Travetto projects. It helps you move from a target outcome to a concrete plan by combining bundle
    recommendations, workflow guidance, operation planning, and snippet selection.
    ...
    <c.Section title="Usage">
      ...
      The recommendation command supports filtering by {d.input('bundles')}, {d.input('workflows')}, {d.input('categories')}, and {d.input('snippet-tags')}. The plan command
      focuses on selected {d.input('operations')} and produces file-level change steps. Execution supports dry-run, overwrite, target directory selection, monorepo bootstrap
      selection ({d.input('--monorepo')}), and several operation-specific hints such as route, controller, service, model, and email naming.
    </c.Section>
    <c.Section title="What It Supports">
      ...
      The available categories exposed by the CLI are {d.input('project')}, {d.input('web')}, {d.input('auth')}, {d.input('model')}, {d.input('upload')}, {d.input('workflow')},{' '}
      {d.input('quality')}, {d.input('email')}, {d.input('test')}, {d.input('config')}, and {d.input('cache')}.
    </c.Section>
    ...
    <c.Section title="Command Options">
      ...
      <ul>
        ...
        <li>
          {d.input('--monorepo')} - when used with {d.input('project-bootstrap')}, generate a workspace root and {d.input('packages/app')} project layout.
        </li>
        <li>
