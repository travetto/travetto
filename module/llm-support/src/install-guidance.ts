...
export const INSTALL_BUNDLES: InstallGuidance[] = [
  {
    ...
    notes: ['Use this baseline for HTTP endpoint development with dependency injection and schema contracts.', 'Add @travetto/openapi when API contract generation is required.'],
  },
  {
    id: 'auth-enabled-web',
  ...
  },
  {
    ...
    required: ['@travetto/web', '@travetto/auth', '@travetto/auth-web', '@travetto/auth-web-passport', '@travetto/config', 'passport', 'passport-google-oauth20'],
  ...
  },
  {
    ...
    required: ['@travetto/web', '@travetto/auth', '@travetto/auth-web', '@travetto/auth-session', '@travetto/auth-web-session', '@travetto/model-memory'],
  ...
  },
  {
    ...
    notes: ['Use this bundle when creating route/controller/service flows backed by model-query.', 'Add auth/auth-web when CRUD endpoints should be principal-scoped.'],
  },
  {
    id: 'model-backend-selection',
    title: 'Model Backend Selection',
    required: ['@travetto/model'],
    optional: ['@travetto/model-elasticsearch', '@travetto/model-mongo', '@travetto/model-sql', '@travetto/model-mysql', '@travetto/model-postgres', '@travetto/model-sqlite'],
    notes: ['Use this bundle to drive backend selection prompts for datastore adapters.', 'Choose exactly one backend adapter for active datastore target.'],
  },
  {
    ...
    notes: ['Use this bundle when generating templates, compiler pipelines, and transport wiring.', 'Add worker when routing send operations through async background execution.'],
  },
];
