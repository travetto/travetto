...
var Ⲑ_mod = ["@travetto/manifest", "doc/test-class.ts"];
class TestClass {
    static Ⲑ_init = Ⲑ_function_1.registerFunction(TestClass, Ⲑ_mod, { hash: 197152026, lines: [1, 3] }, { doStuff: { hash: 51337554, lines: [2, 2] } }, false, false);
    async doStuff() { }
}
