...
const RuntimeIndexRef = d.codeLink('RuntimeIndex', 'src/runtime.ts', /.*RuntimeIndex/);
...
export const text = <>
  ...
  <c.Section title='Class and Function Metadata'>
    ...
    {d.input('Ⲑid')} is used heavily throughout the framework for determining which classes are owned by the framework, and being able to lookup the needed data from the {RuntimeIndexRef} using the {d.method('get')} method.
