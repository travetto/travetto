...
export const text = <>
  ...
  <c.Section title='Path Normalization' >
    ...
    <br />
    imports pointing at ${d.input('node:path/trv')} and ${d.input('path/trv')} are rewritten at compile time to point to the implementation provided by the module.  This allows for seamless import/usage patterns with the reliability needed for cross platform support.
  </c.Section>
