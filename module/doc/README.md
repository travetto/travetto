...
```bash
$ trv doc -i docs/sample.ts -f html

<!-- This file was generated by @travetto/doc and should not be modified directly -->
<!-- Please modify https://github.com/travetto/travetto/tree/master/module/doc/docs/sample.ts and execute "npx trv doc" to rebuild -->
<h1>Documentation
