import { doc as d, lib, mod, inp, SnippetLink, List, Header } from '@travetto/doc';
...
The SSL file options in ${inp`clientOptions`} will automatically be resolved to files when given a path.  This path can be a ${ResourceManager} path or just a standard file path.
`;