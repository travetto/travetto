...
import {
  ...
  ModelBlobSupport, ModelBlobUrlSupport
} from '@travetto/model';
 ...
 */
@Injectable()
export class S3ModelService implements ModelCrudSupport, ModelBlobSupport, ModelBlobUrlSupport, ModelStorageSupport, ModelExpirySupport {
