...
- Multipart flows preserve integrity and clean up on failure.
- Signed URL and range-read behavior remains stable for existing consumers.
- Key naming and namespace resolution remain deterministic.