...
export const text = <>
  <c.StdHeader />
  This is a primary integration for the {d.mod('AuthRest')} module.  This is another level of scaffolding allowing for compatible authentication frameworks to integrate. <br />
