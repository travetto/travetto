...
As you can see, [PassportAuthenticator](https://github.com/travetto/travetto/tree/main/module/auth-rest-passport/src/authenticator.ts#L19) will take care of the majority of the work, and all that is required is:
