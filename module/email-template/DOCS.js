...
${Code('Example inky template with mustache support', 'alt/docs/resources/email/example.email.html')}
...
${Code('resources/email/welcome.html', `alt/docs/resources/email/welcome.email.html`)}
