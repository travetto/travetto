...
import { DecoratorMeta, NodeTransformer, State, TransformPhase, TransformerType } from './types/visitor';
...
function storeHandler(cls: any, fn: Function, phase: TransformPhase, type: TransformerType, target?: string | string[]) {
