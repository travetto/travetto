...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/command/doc/index.ts and execute "npx trv doc" to rebuild -->
# Command
...
```bash
/bin/bash: trv-service: command not found
```
