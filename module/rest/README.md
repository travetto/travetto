...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/rest/README.ts and execute "npx trv doc" to rebuild -->
# RESTful API
...
Additionally, the module is predicated upon [Dependency Injection](module/di#readme "Dependency registration/management and injection support."), and so all standard injection techniques (constructor, fields) work for registering dependencies.
...
The module provides high level access for [Schema](module/schema#readme "Data type registry for runtime validation, reflection and binding.") support, via decorators, for validating and typing request bodies.
...
Per the [Base](module/base#readme "Environment config and common utilities for travetto applications.") module, the following types automatically have rest support as well:
...
Additionally, the [Schema](module/schema#readme "Data type registry for runtime validation, reflection and binding.") module supports typing requests and request bodies for run-time validation of requests. 

## Running an App

By default, the framework provides a default [@Application](https://github.com/travetto/travetto/tree/main/module/app/src/decorator.ts#L21) at [RestApplication](https://github.com/travetto/travetto/tree/main/module/rest/src/application/rest.ts#L21) that will follow default behaviors, and spin up the REST server.  You will need to install the [Application](module/app#readme "Application registration/management and run support.") module to execute.  
...
And using the pattern established in the [Application](module/app#readme "Application registration/management and run support.") module, you would run your program using `npx trv run custom`.
...
Out of the box, the rest framework comes with a few interceptors, and more are contributed by other modules as needed.  The default interceptor set is:
   ...
   **Code: Cors Config**
   ...
   1. [CookiesInterceptor](https://github.com/travetto/travetto/tree/main/module/rest/src/interceptor/cookies.ts#L74) - This interceptor is responsible for processing inbound cookie headers and populating the appropriate data on the request, as well as sending the appropriate response data
...
Currently [Asset Rest Support](module/asset-rest#readme "Provides integration between the travetto asset and rest module.") is implemented in this fashion, as well as [Rest Auth](module/auth-rest#readme "Rest authentication integration support for the travetto framework").
