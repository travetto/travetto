...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/rest/doc/index.ts and execute "npx trv doc" to rebuild -->
# RESTful API
...
By default, the framework provides a default [@Application](https://github.com/travetto/travetto/tree/main/module/app/src/decorator.ts#L20) at [RestApplication](https://github.com/travetto/travetto/tree/main/module/rest/src/application/rest.ts#L20) that will follow default behaviors, and spin up the REST server.  You will need to install the [Application](https://github.com/travetto/travetto/tree/main/module/app#readme "Application registration/management and run support.") module to execute.  
...
Available Applications:
   ...
   ● custom 
     ------------------------
     usage: custom 
     file:  src/custom-app.ts

   ● rest Default rest application entrypoint
     ------------------------------------------------------------------
     usage: rest 
     file:  @trv:rest/src/application/rest.ts
```

### Creating a Custom App
To customize a REST server, you may need to construct an entry point using the [@Application](https://github.com/travetto/travetto/tree/main/module/app/src/decorator.ts#L20) decorator. This could look like:
