...
${d.Execute('Publish execution', 'trv', ['repo:publish', '-h'])}

By default the tool will execute a dry run only, and requires passing a flag to disable the dry run.

${d.Terminal('Publishing changes', 'npx trv repo:publish -d')}
