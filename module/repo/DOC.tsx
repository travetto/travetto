...
`} language='bash' />
    ...
    <c.Section title='CLI - List'>
        ...
        <c.Execution title='List execution of Monorepo' cmd='trv' args={['repo:list']} config={{ cwd: Runtime.context.workspace.path }} />
    </c.Section>
    ...
    <c.Section title='CLI - Exec'>
        ...
        <c.Execution title='List execution of Monorepo' cmd='trv' args={['repo:exec', 'pwd']} config={{ cwd: Runtime.context.workspace.path }} />
    </c.Section>
</>;