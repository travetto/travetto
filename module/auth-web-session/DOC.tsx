...
export const text = (
  <>
    <c.StdHeader />
    One of {d.module('AuthWeb')}'s main responsibility is being able to send, validate and receive authentication/authorization information
    from the client. <br />
    ...
    Once operating within the {Session} boundaries, the session state can be injected via {ContextParam}s, injected as {SessionContext}, or
    accessed via the {SessionService}.
