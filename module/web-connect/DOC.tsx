...
export const text = <>
  <c.StdHeader />
  This module provides basic integration for calling {d.library('Connect')} related middleware with {d.module('Web')}. This logic is not intended to be exhaustive, but intended to provide a quick bridge.  This only consumer of this is {d.module('AuthWebPassport')} as it needs to bind the {WebRequest} and {WebResponse} to standard contracts for {d.library('Passport')}. <br />
  ...
  Barring these exceptions, gaps will be filled in as more use cases arise.  The above exceptions are non-negotiable as they are are enforced by the invocation method defined by {d.module('Web')}.
