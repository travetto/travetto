...
${d.Code('Sample After Transpilation', AppCache.readEntry('doc/transpile.ts'), false, 'javascript')}

And when in ${d.Input('prod')} mode transforms into:

${d.Code('Sample After Transpilation, in Prod', AppCache.readEntry('doc/transpile-prod.ts'), false, 'javascript')}
