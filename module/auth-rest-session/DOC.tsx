...
import { SessionPrincipalCodec } from './src/principal-encoder';
...
export const text = <>
  ...
  The {SessionPrincipalCodec} is exposed as a tool for allowing for decoding/encoding principals into the session.

  <c.Code title={SessionPrincipalCodec.name} src={SessionPrincipalCodec} />
