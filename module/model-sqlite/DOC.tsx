...
export const text = (
  <>
    <c.StdHeader />
    This module provides a {d.library('SQLite')}-based implementation for the {d.module('Model')} module. This source allows the{' '}
    {d.module('Model')} module to read, write and query against {d.library('SQL')} databases. In development mode, the {SQLModelService}{' '}
    ...
    a {d.library('SQL')} database. Every table generated will have a {d.input('path_id')} which determines it's location in the document
    hierarchy as well as sub tables will have a {d.input('parent_path_id')} to associate records with the parent values. <br />
    Supported features:
    <ul>
