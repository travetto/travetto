...
export const text = (
  <>
    <c.StdHeader />
    This module provides a {d.library('Postgres')}-based JSON document-store implementation of the {d.module('Model')}.
    This service allows the {d.module('Model')} module to read, write, index, and query against PostgreSQL using native JSONB columns. <br />
    Supported features:
    <ul>
