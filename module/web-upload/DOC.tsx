...
export const text = <>
  ...
  Once the files are uploaded, they are exposed on {d.mod('Web')}'s request object as {d.field('req.uploads')}. The uploaded files are constructed as {d.input('Blob')} instances.<br />
