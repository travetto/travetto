...
class GridTest {
  ...
  async testNoExpanderImplicit() {
    const input = (
      <Column large={12} small={12} noExpander={true}>
        One
      </Column>
    );
    const expected = (
  ...
  async testWithExpander() {
    const input = (
      <Column large={12} small={12} noExpander={false}>
        One
      </Column>
    );
    const expected = (
  ...
  async testClasses() {
    const input = (
      <Column smallOffset={8} hideSmall={true}>
        One
      </Column>
    );
    const expected = (
      <th className="first last small-12 large-12 columns small-offset-8 hide-for-small">
        <table>
          <tbody>
            <tr>
              <th>One</th>
  ...
  async testAttributes() {
    const input = (
      <Row dir="rtl">
        <Column dir="rtl" valign="middle" align="center">
          One
        </Column>
      </Row>
    );
  ...
  async testBlockGridBasic() {
    ...
    const expected = (
      <table className="block-grid up-4">
        <tbody>
          <tr></tr>
        </tbody>
      </table>
  ...
  async testBlockGridClasses() {
    ...
    const expected = (
      <table className="show-for-large block-grid up-4">
        <tbody>
          <tr></tr>
        </tbody>
      </table>
