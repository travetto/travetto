...
import { Button } from '@travetto/email-inky';
...
class ButtonComponentTest {
  ...
  async testTarget() {
    const input = (
      <Button href="http://zurb.com" target="_blank">
        Button
      </Button>
    );
    const expected = (
              ...
              <td>
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <a href="http://zurb.com" target="_blank">
                          Button
                        </a>
                      </td>
                    </tr>
  ...
  async testClasses() {
    const input = (
      <Button className="small alert" href="http://zurb.com">
        Button
      </Button>
    );
    const expected = (
  ...
  async testExpanded() {
    const input = (
      <Button expanded={true} href="http://zurb.com">
        Button
      </Button>
    );
    const expected = (
                ...
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <center>
                          <a href="http://zurb.com" align="center" className="float-center">
                            Button
                          </a>
                        </center>
                      </td>
