const { doc: d, Install, lib, Mod, inp, List, Note, Code, Section, Execute } = require('@travetto/doc');
const { ModelSource } = require('@travetto/model/src/service/source');
const { SQLModelConfig } = require('./src/config');
const { Model } = require('@travetto/model/src/registry/decorator');
