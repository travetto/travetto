  ...
  return (target: Class<Svc>) => {
    ...
    Object.assign(
      ControllerRegistry.getOrCreateEndpointConfig(
        ...
        }), { priority: 103, method: 'put', path: '/', requestType: { type: cls, description: cls.name }, responseType: { description: cls.name, type: cls } });

    Object.assign(
      ControllerRegistry.getOrCreateEndpointConfig(
        target, async function create(this: Svc, req: Request) {
          return this.source.save(cls, await getSchemaBody(req, cls));
        }), { priority: 104, method: 'post', path: '/', requestType: { type: cls, description: cls.name }, responseType: { description: cls.name, type: cls } });
