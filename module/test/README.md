...
<!-- Please modify https://github.com/travetto/travetto/tree/master/module/test/README.js and execute "npm run docs" to rebuild -->
# Testing
...
To run the tests you can either call the [Command Line Interface](https://github.com/travetto/travetto/tree/master/module/cli#readme "CLI infrastructure for travetto framework") by invoking
