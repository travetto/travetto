const { doc: d, lib, List, Note, pth, Section, inp, Code, meth, Mod, Terminal, Execute, SubSection } = require('@travetto/doc');
const { Suite } = require('./src/decorator/suite');
const { Test } = require('./src/decorator/test');
