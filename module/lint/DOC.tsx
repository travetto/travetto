...
export const text = <>
  <c.StdHeader />
  {d.library('Biome')} is the tool used for linting, formatting, and organizing imports in {d.library('Typescript')} and {d.library('Javascript')} code. This module provides a unified CLI interface and standard linting patterns.

  In a new project, the first thing that will need to be done, post installation, is to create the Biome configuration file.
  ...
  <c.CliHelpSection commandClass={LintRegisterCommand}>
    ...
    <c.Code title='Sample configuration' src='../../biome.json' />
  </c.CliHelpSection>
