...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/cli/doc/index.ts and execute "npx trv doc" to rebuild -->
...
Commands:
  ...
  repo:test [options]
  repo:version [level] [prefix?]
  run [options] [application] [args...]
  test [options] [regexes...]
  test:all [options] [folders...]
