import { AppError, BinaryUtil, castTo, EncodeUtil } from '@travetto/runtime';
...
export class TestController {
  ...
  getStream() {
    return BinaryUtil.toBinaryStream(EncodeUtil.fromUTF8String('hello'));
  }

  @Get('/buffer')
  @Produces('text/plain')
  getBuffer() {
    return EncodeUtil.fromUTF8String('hello');
  }
