...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/model-elasticsearch/DOC.tsx and execute "trv doc" to rebuild -->
...
pnpm add @travetto/model-elasticsearch
```
