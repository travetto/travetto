...
//         .filter(x => index === ModelRegistry.getStore(x))!;
...
//    */
//   onChange<T extends ModelType>(e: ChangeEvent<Class<T>>): void {
...
//         index: this.getNamespacedIndex(this.getStore(e.prev))
//       });
...
//    */
//   getPlainSearchObject<T extends ModelType>(cls: Class<T>, query: Query<T>): Search {
...
//    * Noop
//    */
//   prePersist<T extends ModelType>(cls: Class<T>, o: T) {
//     return o;
//   }
...
//   async getIdsByQuery<T extends ModelType>(cls: Class<T>, query: ModelQuery<T>) {
...
//   getIndices<T extends ModelType>(classes: Class<T>[]) {
...
//   async getAllByQuery<T extends ModelType>(cls: Class<T>, query: PageableModelQuery<T> = {}): Promise<T[]> {
//     return this.query(cls, query);
//   }

//   async getCountByQuery<T extends ModelType>(cls: Class<T>, query: ModelQuery<T> = {}): Promise<number> {
...
//   async getById<T extends ModelType>(cls: Class<T>, id: string): Promise<T> {
//     try {
//       // @ts-ignore
...
//   async deleteById<T extends ModelType>(cls: Class<T>, id: string): Promise<number> {
//     const conf = ModelRegistry.get(cls);
//     if (conf.subType) {
//       try {
...
//   async save<T extends ModelType>(cls: Class<T>, o: T, keepId: boolean = false): Promise<T> {
...
//   async saveAll<T extends ModelType>(cls: Class<T>, objs: T[], keepId: boolean = false): Promise<T[]> {
//     for (const x of objs) {
//       if (!keepId) {
//         delete x.id;
//       }
...
//   async updatePartialByQuery<T extends ModelType>(cls: Class<T>, query: ModelQuery<T>, data: Partial<T>): Promise<T> {
//     if (!data.id) {
...
//   async updateAllByQuery<T extends ModelType>(cls: Class<T>, query: ModelQuery<T> = {}, data: Partial<T>) {
...
//   async bulkProcess<T extends ModelType>(cls: Class<T>, operations: BulkOp<T>[]) {
