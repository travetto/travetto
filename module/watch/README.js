const { doc: d, Code, Section, inp, lib } = require('@travetto/doc');
const { Watcher } = require('./src/watcher');
const { RetargettingProxy } = require('./src/proxy');
...
${Code(d`Example of using the ${RetargettingProxy.name}`, 'alt/docs/src/proxy.ts')}
`;