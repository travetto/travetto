const { doc: d, Mod, Config, List, inp, Section, meth, Code, Ordered, Execute, pth, lib, fld } = require('@travetto/doc');
const { ConfigManager } = require('./src/manager');
const { Config: ConfigDec } = require('./src/decorator');
