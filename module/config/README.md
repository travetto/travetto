...
<!-- Please modify https://github.com/travetto/travetto/tree/main/module/config/doc/index.ts and execute "npx trv doc" to rebuild -->
# Configuration
...
/bin/bash: ./src/resolve.ts: Permission denied
```
...
/bin/bash: ./src/dbconfig-run.ts: Permission denied
```
