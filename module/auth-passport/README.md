...
<!-- Please modify https://github.com/travetto/travetto/tree/master/module/auth-passport/README.ts and execute "npm run docs" to rebuild -->
# Passport Auth
...
As you can see, [PassportIdentitySource](https://github.com/travetto/travetto/tree/master/module/auth-passport/src/identity.ts#L14) will take care of the majority of the work, and all that is required is:
